defmodule SimpleRepo.Support.Fixtures do
  ...
  def test_structs do
    ...
    [
      %{uuid: Ecto.UUID.generate(), name: "S1", type: "foo", value: 1, f_value: nil, jsonb: json1()},
      %{uuid: Ecto.UUID.generate(), name: "S2", type: "foo", value: 2, f_value: 42.2, jsonb: %{}},
      %{uuid: Ecto.UUID.generate(), name: "S3", type: "foo", value: 2, f_value: 41.3, jsonb: json2()},
      %{uuid: Ecto.UUID.generate(), name: "S4", type: "bar", value: 4, f_value: 42.2, jsonb: json3()},
      %{uuid: Ecto.UUID.generate(), name: "S5", type: "bar", value: 5, f_value: 39.7, jsonb: json4()},
      %{uuid: Ecto.UUID.generate(), name: "S6", type: "baz", value: 6, f_value: 43.1, jsonb: json1()},
      %{uuid: Ecto.UUID.generate(), name: "S7", type: "baz", value: nil, f_value: nil, jsonb: nil}
    ]
